...
export default function Step2() {
  return (
    <div id="step-2" className="bg-beach text-align-right homepage-container-padding-font">
      ...
      <br />
      <div className="color-blue semibold">Within 5 minutes after you've create your GSCF's profile...</div>
