...
export default function Introduction() {
  return (
    <div id="introduction" className="bg-beach homepage-container-padding">
      ...
      <p id="for-people" className="color-red text-align-justify">
      ...
      <br />
      <p className="color-red">We hope this inspires you to say, “Match us up!” </p>
      <br />
      <p className="color-blue text-align-justify">
